...
ALTER TABLE `monitor_condition` ADD FOREIGN KEY (`monitor_id`) REFERENCES `monitor` (`id`);

ALTER TABLE `monitor_condition` ADD FOREIGN KEY (`condition_id`) REFERENCES `condition` (`id`);
