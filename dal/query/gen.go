...
type queryCtx struct {
	...
	Monitor           *monitorDo
	MonitorCondition  *monitorConditionDo
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		...
		Condition:         q.Condition.WithContext(ctx),
		...
		MonitorCondition:  q.MonitorCondition.WithContext(ctx),
