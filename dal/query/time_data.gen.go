...
func newTimeDatum(db *gorm.DB, opts ...gen.DOOption) timeDatum {
	...
	_timeDatum.StartTime = field.NewTime(tableName, "start_time")
	_timeDatum.EndTime = field.NewTime(tableName, "end_time")
	...
	_timeDatum.Condition = field.NewString(tableName, "condition")
