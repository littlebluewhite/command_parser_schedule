...
func newTaskTemplateStage(db *gorm.DB, opts ...gen.DOOption) taskTemplateStage {
	...
	_taskTemplateStage.ID = field.NewInt32(tableName, "id")
	_taskTemplateStage.TaskTemplateID = field.NewInt32(tableName, "task_template_id")
	_taskTemplateStage.StageID = field.NewInt32(tableName, "stage_id")
...
func (t *taskTemplateStage) updateTableName(table string) *taskTemplateStage {
	...
	t.StageID = field.NewInt32(table, "stage_id")
...
func (t taskTemplateStageDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) *taskTemplateStageDo {
